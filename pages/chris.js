      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}> 
          ...
          <div>
            ...
            <img src="/svgs/code.svg" alt="cloud-native" className={styles.logo} />{' '}Founder & Organiser <a href="https://www.meetup.com/Wellington-Web-Dev/" target="_blank">Web Dev Meetup Wellington</a><br />
            ...
            <img src="/svgs/code.svg" alt="cloud-native" className={styles.logo} />{' '}Founder & Organiser <a href="https://www.meetup.com/Wellington-DevOps-Group/" target="_blank">Devops Meetup Wellington</a><br />
            <img src="/svgs/code.svg" alt="cloud-native" className={styles.logo} />{' '}Founder & Organiser <a href="https://www.meetup.com/Cloud-Native-Auckland/" target="_blank">Cloud Native Meetup Auckland</a> <br />
            <img src="/svgs/code.svg" alt="cloud-native" className={styles.logo} />{' '}Founder & Organiser <a href="https://connecta.dev" target="_blank">Connecta.DEV (online community)</a><br />
